                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-7 col-md-12 col-sm-12">
                                <div class="card shadow mb-4">
                                    ...
                                    <!-- Card Body -->
                                    <div class="card-body">
                                    <form action="add-post.php" class="needs-validation" enctype="multipart/form-data"  method="post" novalidate>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description" value="<?php $p_description ?>" class="form-control" required>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="">Post Image:</label>
                                            <input type="file" name="img" value="<?php echo $file ?>" class="form-control" required>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label for="">Category</label>
                                            <select name="category[]" multiple class="form-control" id="" required>
                                        ...
                                        <br>
                                        <button name="submit_post" class="btn btn-primary p-2">Submit Post</button>
                                    </form>
                                    </div>
                                </div>
                            </div>
